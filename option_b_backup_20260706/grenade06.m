...
relax_rho = 0.1;        % density (EOS) under-relaxation, wc3-style [-]
...
hist   = zeros(nsteps,9);       % [B] t, pbar, Tvent, uvent, m_in, m_vent, massErr, xf, K2prod
...
fprintf(fh,'# t[s]  pbar[Pa]  Tvent[K]  uvent[m/s]  m_in[kg/s/m]  m_vent[kg/s/m]  massErr  xf[m]  K2CO3[kg/m]\n');
for n = 1:istep
